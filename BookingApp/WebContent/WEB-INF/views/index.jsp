...
<script>
  $( function() {
	...
	function doConfirm() {
		...
		if ( valid ) {
//		  	window.location.href="/reservation/confirm?name="+name.val()+"&phone="+phone.val();
...
<body>
	...
	<div class="main">
	    ...
	    <div class="menubar">
	    	<div class="button" onclick="location.href='/reservation/register';"><strong>예약하기</strong></div>
